    ...
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      <div className="prose mt-8 space-y-6 text-sm leading-relaxed text-ink-2">
        ...
        <section>
          ...
          <p className="mt-2">
            Видеозанятия проводятся через Zoom на аккаунте, который преподаватель подключает к
            платформе самостоятельно. Платформа не несёт ответственности за перебои в работе
            сторонних сервисов (Zoom и т.п.).
          </p>
        </section>
