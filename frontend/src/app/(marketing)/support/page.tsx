  ...
  return (
    <div className="mx-auto max-w-3xl px-5 py-10">
      ...
      <div className="mt-8 space-y-6 text-sm leading-relaxed text-ink-2">
        ...
        <section className="card p-6">
          <h2 className="display text-lg">Проблемы с видеосвязью</h2>
          <p className="mt-2">
            Если не получается подключиться к видеоуроку — напишите об этом через «Сообщения» или
            тикет с описанием проблемы.
          </p>
        </section>
      </div>
    </div>
