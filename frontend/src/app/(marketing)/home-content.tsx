...
const HERO_PILLS = [
  ...
  { icon: Video, label: "Занятия в Zoom" },
      ...
      <div className="relative mx-auto max-w-7xl px-5 pb-16 pt-16 md:pb-24 md:pt-24">
        <motion.div className="mx-auto max-w-2xl text-center" {...fadeUp(0)}>
          ...
          <p className="mt-6 text-lg leading-relaxed text-ink-2">
            Личные сообщения с преподавателем, занятия в Zoom по расписанию курса и AI-помощник для
...
const FEATURES = [
  ...
  {
    icon: Video,
    title: "Занятия в Zoom по расписанию",
    text: "Каждое занятие курса — это настоящая Zoom-встреча, которая создаётся автоматически на аккаунте преподавателя.",
    tone: "citrus",
  },
  {
    icon: Sparkles,
...
const STEPS = [
  ...
  },
  {
    ...
    text: "Присоединяйтесь к занятиям в Zoom по расписанию курса, общайтесь с преподавателем и группой.",
  },
];
