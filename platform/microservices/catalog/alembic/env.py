"""Alembic environment for the catalog department.

Runs migrations against the catalog schema only, inside the one shared
...
import app.modules.tutors.models.tutor  # noqa: F401
import app.modules.students.models.student  # noqa: F401
