"""Alembic environment for the engagement department.

Runs migrations against the engagement schema only, inside the one shared
...
import app.modules.notifications.models.preference  # noqa: F401
