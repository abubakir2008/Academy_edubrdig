"""Alembic environment for the finance department.

Runs migrations against the finance schema only, inside the one shared
...
import app.modules.payments.models.payment  # noqa: F401
import app.modules.wallet.models.wallet  # noqa: F401
