"""Alembic environment for the identity department.

Runs migrations against the identity schema only, inside the one shared
...
import app.modules.users.models.profile  # noqa: F401
