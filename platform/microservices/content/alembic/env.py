"""Alembic environment for the content department.

Runs migrations against the content schema only, inside the one shared
...
import app.modules.ai.models.ai_log  # noqa: F401
import app.modules.cms.models.content  # noqa: F401
import app.modules.localization.models.localization  # noqa: F401
